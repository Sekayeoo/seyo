...
const expiredCheck = (seyo, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            seyo.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              seyo.groupLeave(_dir[position].id)
