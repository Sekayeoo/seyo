...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const wr = { a: global.author ? global.author : 'sekayeoo', b: data.packname ? data.packname : global.packname ? global.packname : 'Bot WhatsApp', c: data.author ? data.author : global.author ? global.author : 'Sekayeoo', d: data.categories ? data.categories : [""], e: data.isAvatar ? data.isAvatar : 0 }
